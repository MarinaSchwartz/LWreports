...
ggsave("Lake/output_graphs/total_p_graph.png", width = 7, height = 6, units = "in", dpi = 300)

```

```{r total p graph out, out.width= "475px",fig.align = "center"}
...
```{r chl graph out, out.width= "450px",fig.align = "center"}
...
```{r secchi_graph out, out.width= "450px",fig.align = "center"}
