...
ggsave("output/output_graphs/total_p_graph.png", width = 6, height = 4, units = "in", dpi = 300)
...
ggsave("output/output_graphs/total_n_graph.png", width = 6, height = 4, units = "in", dpi = 300)
...
##commented out so the graph does not show up twice.
ggsave("output/output_graphs/total_chl_graph.png", width = 6, height = 4, units = "in", dpi = 300)
...
###commented out so the graph does not show up twice.
ggsave("output/output_graphs/total_secchi_graph.png", width = 6, height = 4, units = "in", dpi = 300)
