...
#define variables
cnty <- Lake$County.x[1] #county
name <- Lake$Lake.x[1] #name
...
gnis <- Lake$GNIS_ID[1]
lat <- Lake$Latitude[1]
long <- Lake$Longitude[1]
wbt <- Lake$`water type`[1]
sa <- paste(Lake$`SA (hectare)`[1], "ha, ", Lake$`SA (acres)`[1], "acres")
...
gtsave(table_three, filename = "table_3.png", path = "output/output_table")
