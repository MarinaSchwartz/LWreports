...
```{r Figure_one_image, echo=FALSE, out.width= "500px", fig.align='center',}
...
knitr::include_graphics("Table 1 RiverStream.png")
```
...
table_two = gt(tbl2df) %>% tab_options(column_labels.hidden = TRUE) %>% fmt_number(
  ...
  title = md("**Table 2.** Base File Data."))  

gtsave(table_two, filename = "table_2.png", path = "RiverStream/output_table")

```

```{r table 2, out.width= "500px", fig.align='center'}
knitr::include_graphics("RiverStream/output_table/table_2.png")
```
...
### Table 3. Long-term trophic state data collected monthly by LAKEWATCH volunteers and color and specific conductance (collected quarterly).
...
gtsave(table_three, filename = "table_3.png", path = "RiverStream/output_table")


```

```{r table 3, out.width= "500px", fig.align='center'}
knitr::include_graphics("RiverStream/output_table/table_3.png")
```
...
ggsave("RiverStream/output_graphs/total_p_graph.png", width = 8, height = 6, units = "in", dpi = 300)

```

```{r total p graph out, out.width= "450px",fig.align = "center"}

knitr::include_graphics("RiverStream/output_graphs/total_p_graph.png")
```
...
ggsave("RiverStream/output_graphs/total_n_graph.png", width = 8, height = 6, units = "in", dpi = 300)
...
knitr::include_graphics("RiverStream/output_graphs/total_n_graph.png")
...
##commented out so the graph does not show up twice.
ggsave("RiverStream/output_graphs/total_chl_graph.png", width = 8, height = 6, units = "in", dpi = 300)

```

```{r chl graph out, out.width= "500px",fig.align = "center"}

knitr::include_graphics("RiverStream/output_graphs/total_chl_graph.png")
...
###commented out so the graph does not show up twice.
ggsave("RiverStream/output_graphs/total_secchi_graph.png", width = 8, height = 6, units = "in", dpi = 300)

```

```{r secchi_graph out, out.width= "500px",fig.align = "center"}

knitr::include_graphics("RiverStream/output_graphs/total_secchi_graph.png")
